...
namespace LakeXplorerProject.Migrations
{
    ...
    [Migration("20230808011358_like_UserReference")]
    partial class like_UserReference
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LakeXplorerProject.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("LakeXplorerProject.Models.Like", b =>
                {
                    ...
                    b.HasOne("LakeXplorerProject.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LakeXplorerProject.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
